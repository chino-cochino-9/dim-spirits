...
let you: Sprite = null
music.play(music.createSong(hex``), music.PlaybackMode.LoopingInBackground)
...
game.onUpdate(function () {
    if (sprites.allOfKind(SpriteKind.alien).length == 0 && sprites.allOfKind(SpriteKind.Enemy).length == 0) {
        spawnen(enlist)
    }
})
game.onUpdate(function () {
    if (round == 5) {
        game.splash("you win!", "start over?")
        game.reset()
    }
})
